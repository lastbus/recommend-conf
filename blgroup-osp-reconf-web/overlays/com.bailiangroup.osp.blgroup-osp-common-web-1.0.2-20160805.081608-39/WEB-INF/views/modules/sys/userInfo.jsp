...
<body>
	...
	<form:form id="inputForm" modelAttribute="currentUser" action="${ctx}/sys/user/info" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="lbl">${fns:getDictLabel(currentUser.userType, 'sys_user_type', '无')}</label>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">用户角色:</label>
			<div class="controls">
				<label class="lbl">${currentUser.roleNames}</label>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">最后登陆:</label>
			<div class="controls">
				<label class="lbl">IP: ${currentUser.loginIp}&nbsp;&nbsp;&nbsp;&nbsp;时间：<fmt:formatDate value="${currentUser.loginDate}" type="both" dateStyle="full"/></label>
			</div>
		</div>
