	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="roleType">
					<form:options items="${fns:getDictList('user_osp_role_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:input path="roleCode" htmlEscape="false" maxlength="50" />
			</div>
		</div>
